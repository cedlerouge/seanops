...
git config --global user.email "seanops-bot@users.noreply.github.com"
git config --global user.name "seanops-bot"
git config --global push.default simple

rm -rf deployment
git clone -b master https://github.com/cedlerouge/seanops.github.io.git deployment
